...
class _AvailableCollectionsPageState extends State<AvailableCollectionsPage> {
  ...
  List<CollectionCardData> get _coletasFiltradas {
    return widget.coletas.where((coleta) {
      // Mostra coletas disponíveis (que vieram da API com status 'available')
      final isAvailable = coleta.status == CollectionStatus.available;
      final matchBairro =
      ...
      return isAvailable && matchBairro && matchSearch;
    }).toList();
  }
